<div class="wrap">
    ...
    <ul class=" nav nav-tabs">
        <li class="<?php echo !isset($_POST["edit_taxonomy"])
                        ? "active"
                        : ""; ?>"><a href="#tab-1">Your Custom Taxonomies</a></li>
    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane <?php echo !isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
            ...
            <?php
            $options = get_option('smart_plugin_tax') ?: array();
            ...
            foreach ($options as $option) {
                ...
                settings_fields('smart_plugin_tax_settings');
        ...
        <div id="tab-2" class="tab-pane  <?php echo isset($_POST["edit_taxonomy"])
                                                ? "active"
                                                : ""; ?>">
            ...
            <form method="post" action="options.php">
                <?php
                settings_fields("smart_plugin_tax_settings");
                do_settings_sections("smart_plugin_taxonomy");
                submit_button();
                ?>
            </form>
        </div>
